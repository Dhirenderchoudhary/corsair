...
List Messenger conversations for a Page.
...
| `recipient_id` | `string` | Yes | — |
| `message` | `string` | Yes | — |
| `messaging_type` | `RESPONSE \| UPDATE \| MESSAGE_TAG` | No | — |
| `tag` | `string` | No | — |
...
|------|------|----------|-------------|
| `page_id` | `string` | Yes | — |
| `user` | `string` | Yes | Facebook User ID to assign tasks to. |
...
|------|------|----------|-------------|
| `page_id` | `string` | Yes | Facebook Page ID |
| `metric` | `string \| string[]` | Yes | Insight metric name(s), e.g. page_impressions. |
...
Remove a user from Page task assignments.
...
|------|------|----------|-------------|
| `page_id` | `string` | Yes | — |
| `user` | `string` | Yes | Facebook User ID to remove from Page tasks. |
...
Create and publish a photo post on a Page.
...
Publish or schedule a Page feed post.
...
List posts published on a Facebook Page.
...
| `type` | `LIKE \| LOVE \| WOW \| HAHA \| SAD \| ANGRY \| CARE` | No | Reaction type. Defaults to LIKE when omitted. |
...
List videos uploaded to a Page.
