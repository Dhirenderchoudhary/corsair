...
export const ExampleEventSchema = FacebookWebhookPayloadSchema.extend({
...
export function createFacebookMatch(eventType: string): CorsairWebhookMatcher {
...
export function verifyFacebookWebhookSignature(
	request: WebhookRequest<FacebookWebhookPayload>,
	secret: string,
